...
console.log('[Question #8]: ', acronym8); // Answer should be: ITB
...
console.log('[Question #14]: ', apostlesString14); // Answer should be: Peter, James, John, Andrew, Philip, Bartholomew, Matthew, Thomas, James, Thaddeus, Simon, Judas
